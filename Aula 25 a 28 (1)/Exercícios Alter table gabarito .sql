...
alter table pacintes modify column data_nascimento date;
...
alter table veiculos_empresa modify column placa date;
...
alter table turmas add column modalidade Enum('Presencial', 'Onlime');
describe turmas;

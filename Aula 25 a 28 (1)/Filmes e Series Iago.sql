...
select titulo, id_midia from midias order by ano_lancamento desc;
select * from midias where ano_lancamento =  1994;
select * from midias  where tipo = 'filme' and genero like '%Ficção Cientifica';
select * from midias where tipo = 'serie' and genero like '%Crime'or genero like  '%Drama';
...
update midias set genero = 'comedia, sitcom' where titulo = 'Friends';
